...
export function shortestSentenceByWhiteSpaces(input: string, byWhiteSpaces: boolean): string {
  ...
  return `najkrótsze zdanie pod kątem ilości znaków: ${inputSplit[position]}, długość: ${lenght}`;
}
